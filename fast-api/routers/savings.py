...
@router.post("/", response_model=Savings)
...
@router.get("/", response_model=List[Savings])
def read_savings():
    return savings_db

@router.get("/{savings_id}", response_model=Savings)
...
@router.put("/{savings_id}", response_model=Savings)
